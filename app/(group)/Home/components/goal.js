...
export function Goal() {
  return (
    <div className=" mt-20 md:mt-0 px-5 md:px-0 md:p-5 z-10 flex flex-col lg:flex-row md:h-[90vh] w-full lg:items-center justify-between font-mono text-sm lg:flex gap-20">
