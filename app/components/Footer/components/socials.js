    ...
    return (
        <div>
            ...
            <div className='flex flex-col gap-5'>
                <p className='mb-5 font-poppins text-sm md:text-base '>1/3 Adebola Gbadebo Drv. (Adebola House) Off Abadek Avenue, off Akin Ogunlewe Rd, Igbogbo, Ikorodu, Lagos.</p>
                <Link className='font-poppins text-sm md:text-base ' href="/create">support@web3bridge.com</Link>          
            </div>
        </div>
    )
}